...
var options = {
  src: './metro/static/js/index.js',
  dest: './metro/static/js/',

  modernizr: {
    src: './metro/static/js/index.js',
    dest: './metro/static/libs/',
  },

  css: {
    src: './metro/static/less/index.less',
    watch: './metro/static/less/**/*.less',
    dest: './metro/static/css/'
  },
  development: false
}
...
gulp.task('test', function () {
  ...
  return gulp
    ...
    .on('finish', function () {
      gulp
        .src('./metro/static/js/test/**/test_*.js', {read: false})
        .pipe(mocha({
          require: [
