...
DATABASES['default']['NAME'] = 'metro_%s' % ENVIRONMENT.lower()
DATABASES['default']['USER'] = 'metro_%s' % ENVIRONMENT.lower()
DATABASES['default']['HOST'] = os.environ.get('DB_HOST', '')
DATABASES['default']['PORT'] = os.environ.get('DB_PORT', '')
DATABASES['default']['PASSWORD'] = os.environ.get('DB_PASSWORD', '')

WEBSERVER_ROOT = '/var/www/metro/'
...
EMAIL_SUBJECT_PREFIX = '[Metro %s] ' % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://metro_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/metro_%(ENVIRONMENT)s' % os.environ  # noqa
